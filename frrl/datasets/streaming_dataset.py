...
from frrl.datasets.lerobot_dataset import CODEBASE_VERSION, LeRobotDatasetMetadata
...
from frrl.utils.constants import HF_LEROBOT_HOME, LOOKAHEAD_BACKTRACKTABLE, LOOKBACK_BACKTRACKTABLE
...
class StreamingLeRobotDataset(torch.utils.data.IterableDataset):
    ...
    Example:
        Basic usage:
        ```python
        from frrl.common.datasets.streaming_dataset import StreamingLeRobotDataset
