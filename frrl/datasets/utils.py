...
from frrl.datasets.backward_compatibility import (
    FUTURE_MESSAGE,
    BackwardCompatibilityError,
    ForwardCompatibilityError,
)
from frrl.utils.constants import ACTION, OBS_ENV_STATE, OBS_STR
from frrl.utils.utils import SuppressProgressBars, is_valid_numpy_dtype_string
...
def to_parquet_with_hf_images(df: pd.DataFrame, path: Path) -> None:
