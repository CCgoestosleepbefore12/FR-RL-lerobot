...
from frrl.envs.configs import AlohaEnv, EnvConfig, LiberoEnv, PushtEnv
from frrl.envs.utils import _call_make_env, _download_hub_file, _import_hub_module, _normalize_hub_result
from frrl.policies.xvla.configuration_xvla import XVLAConfig
from frrl.processor import ProcessorStep
from frrl.processor.env_processor import LiberoProcessorStep
from frrl.processor.pipeline import PolicyProcessorPipeline
...
def make_env_pre_post_processors(
    ...
    if isinstance(policy_cfg, XVLAConfig):
        from frrl.policies.xvla.processor_xvla import make_xvla_libero_pre_post_processors
...
def make_env(
    ...
    if "libero" in cfg.type:
        from frrl.envs.libero import create_libero_envs
        ...
        from frrl.envs.metaworld import create_metaworld_envs
