...
from frrl.robots.franka_real.camera_drain import (
    drain_sleep, wait_for_operator_with_camera_drain,
    check_hand_close_during_homing, interpolate_move_with_drain,
)
...
def main():
    ...
    try:
        ...
        # 这里 catch 是兜底（万一 input() / subprocess wait 等绕过了 flag）。
